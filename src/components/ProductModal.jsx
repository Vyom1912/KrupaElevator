            ...
            <div className="w-full flex justify-between items-center pb-3 border-b border-slate-100">
              <div className="flex items-center space-x-2">
                ...
                <h4 className="text-sm sm:text-base font-black text-slate-900">
                  {product.name} — Architectural Hoistway GA Drawing
                </h4>
              </div>
              <button
                onClick={() => setZoomDrawing(false)}
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <div className="flex flex-wrap items-center gap-2 mb-1.5">
                ...
                <span className="px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-teal-50 border border-teal-200 text-teal-800">
                  ISO 9001:2015
                </span>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 border-b border-slate-200/80 pb-3">
              <div>
                ...
                <span className="text-[11px] text-slate-500 block mt-0.5">
                  Official architectural dimensions & shaft clearances per IS 14665 standards
                </span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Standard engineering dimensions with common specifications merged for optimal architectural readability.
                </p>
              </div>
          ...
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
            ...
            <a
              href={`https://wa.me/${companyData.contacts.whatsapp}?text=${encodeURIComponent(
                `Hello Krupa Elevators, I would like to inquire about ${product.name} specifications and GA drawing.`
              )}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center space-x-1.5 px-4 py-2 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-white text-xs font-bold transition-all shadow-xs"
            >
