...
/* ── Hero ─────────────────────────────────────────────────── */
const CHIPS = ['VVVF Drive', 'PMSM Motor', 'Regenerative', 'VDI 4707 A+', 'ARD', 'Auto Leveling']
    ...
    <section className="hero" aria-label="Hero banner">
      <div className="hero-left">
        ...
        <h1 className="hero-heading">
          Elevating Your World<br />with <em>Precision &amp; Style</em>
        </h1>
        <p className="hero-body">
          Krupa Elevators delivers world-class vertical transportation — Passenger, Hospital,
          Goods, Capsule, Car, Home, MRL and Hydraulic elevators — engineered for safety,
          efficiency and elegance across Gujarat, India.
        </p>
        <div className="hero-ctas">
          <Link to="/products" className="btn-primary">Explore Our Elevators</Link>
          <Link to="/contact"  className="btn-outline">Get a Quote</Link>
        </div>
        <div className="hero-floor" aria-live="polite" aria-label="Floor display">
        ...
        <div className="strip-inner">
          <div className="strip-left">
            ...
            <div className="strip-chips">
              {CHIPS.map(c => <span key={c} className="strip-chip">{c}</span>)}
            </div>
          </div>
          <p className="strip-quote">
            "A flexible solution that unifies form and function. An all-round elevator applicable to multiple building types with outstanding architectural flexibility for car door and shaft dimensions. Precise assures smooth and safe user experience"
          </p>
        </div>
      </div>
    </div>
...
/* ── Why Krupa ────────────────────────────────────────────── */
const WHY_CARDS = [
  { title: 'Quality Manufacturing', text: 'In-house facility with quality control at every stage of production.' },
  { title: 'Experienced Team',      text: 'Trained engineers and technicians delivering strict maintenance standards.' },
  { title: '8 Product Lines',       text: 'Passenger, Hospital, Goods, Capsule, Car, Home, MRL and Hydraulic.' },
  { title: '5000 kg Max Load',      text: 'Goods and Car elevators rated up to 5000 kg for industrial use.' },
]
        ...
        <div className="why-inner">
          <div>
            ...
            <h2 className="why-heading" id="why-heading">
              Built on Quality,<br />Backed by Service
            </h2>
            <p className="why-body">
              Krupa Elevators combines German motor technology, microprocessor controls,
              and skilled local expertise to deliver elevators that perform reliably for decades.
            </p>
          </div>
      ...
      <div className="wrap">
        <div className="product-preview-head">
          <div>
            ...
            <h2 className="section-heading" id="products-preview-h">Eight Product Lines</h2>
            <p className="section-subtext">
              Residential to industrial — each elevator built to spec with full technical documentation.
            </p>
          </div>
        ...
        <div className="product-grid">
          {ELEVATORS.map(elev => (
            <Link key={elev.id} to={`/products#${elev.id}`} className="product-card">
        ...
        <div className="tech-preview-inner">
          <div>
            ...
            <p className="section-subtext" style={{ marginBottom: '28px' }}>
              VDI 4707 Energy Efficiency Class A+ certified drives, German PMSM motors,
              and regenerative energy recovery on every premium unit.
            </p>
            {features.map(f => (
...
/* ── Service Preview ──────────────────────────────────────── */
const SVC_CARDS = [
  { img: '/images/service_1.jpg', alt: 'Service team',  title: 'Specialized Service Team', text: 'Strict on-the-job training, strong technical network and management system.' },
  { img: '/images/service_2.jpg', alt: 'Spare parts',   title: 'Superior Spare Parts',     text: 'All parts tested before delivery. Rapid supply network across north India.' },
  { img: '/images/service_3.jpg', alt: 'Monitoring',    title: '24-Hour Monitoring',       text: 'Remote elevator monitoring with timely alarm, rescue and maintenance.' },
]
    ...
    <section className="service-preview" aria-labelledby="svc-preview-h">
      <div className="wrap">
        <div className="service-preview-head">
          <div>
            <SectionLabel style={{ color: 'rgba(255,255,255,.55)' }}>After Sales</SectionLabel>
            <h2 className="service-preview-title" id="svc-preview-h">
              SHARING Wonder Together
            </h2>
          </div>
          <Link to="/service" className="service-preview-more">Learn More →</Link>
        </div>
...
const CONTACT_INFO = [
  ...
  { icon: '📍', label: 'Address', val: 'FF-6 Sagun Enclave, Beside Nikol Community Hall,\nNr. Manohar Vill Char Rasta, Nikol,\nAhmedabad – 382430, Gujarat' },
]
        ...
        <div className="contact-cta-inner">
          <div>
            ...
            <h2 className="contact-cta-heading" id="cta-h">
              Ready to Install?<br />Let's Talk.
            </h2>
            <p className="contact-cta-body">
              From initial consultation to installation and long-term maintenance —
              our team is ready to help with every step of your elevator project.
            </p>
            ...
            {CONTACT_INFO.map(item => (
              <div className="contact-info-item" key={item.label}>
                ...
                <div>
                  ...
                  <div className="contact-info-val" style={{ whiteSpace: 'pre-line' }}>{item.val}</div>
                </div>
              </div>
            ))}
          </div>
