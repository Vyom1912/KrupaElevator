      ...
      <section className="relative h-[calc(100vh-80px)] min-h-[520px] max-h-[850px] flex items-center overflow-hidden bg-slate-950 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
          <div className="max-w-2xl lg:max-w-3xl space-y-4 sm:space-y-5">
            ...
            {/* Authentic Company Highlights (No fake metrics) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm text-slate-300 py-1">
              <div className="flex items-center space-x-2">
                <CheckCircle2 className="w-4 h-4 text-brand-teal shrink-0" />
                <span>Manufacturing Works at Bakrol Industrial Hub</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle2 className="w-4 h-4 text-brand-teal shrink-0" />
                <span>End-to-End: Design, Installation & AMC</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle2 className="w-4 h-4 text-brand-teal shrink-0" />
                <span>Passenger, Glass Home, Hospital & Freight Lifts</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle2 className="w-4 h-4 text-brand-teal shrink-0" />
                <span>Direct Local Technical Team & 24/7 Breakdown Support</span>
              </div>
            </div>
