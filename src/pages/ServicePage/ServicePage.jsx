          ...
          <div className='service-intro-inner'>
            <div>
              ...
              <p className='service-intro-body'>
                Krupa Elevators provides end-to-end support — from installation
                through to long-term preventive maintenance. Our team is trained
                to keep your elevator running at peak performance for the
                lifetime of the unit.
              </p>
              <p className='service-intro-body'>
                With a distribution network spanning north India and a 24-hour
                monitoring system, we ensure every customer gets rapid, reliable
