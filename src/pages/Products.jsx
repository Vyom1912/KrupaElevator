...
export default function Products() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <ScrollReveal direction="up" delay={60} distance={15} duration={500}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProducts.map((product, idx) => (
            <ScrollReveal
              ...
              className="h-full"
            >
              <div className="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between group h-full">
                <div>
                  {/* Visual Header */}
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-5 pt-4 border-t border-slate-100 space-y-1.5 text-xs">
                      {Object.entries(product.keySpecs).slice(0, 4).map(([k, v], sIdx) => (
      ...
      <ScrollReveal direction="up" distance={20} duration={500}>
        <section className="bg-slate-900 text-white rounded-3xl p-8 sm:p-12 space-y-8 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {doorSystemsData.map((category, dIdx) => (
              <div key={dIdx} className="bg-slate-800/80 border border-slate-700 p-6 rounded-2xl space-y-4">
                <div>
