...
import { capsuleGlass, serviceRight } from "../../image";
...
function ManualSVG() {
  return (
    <svg
      ...
      width='270'
      height='308'
      aria-label='Manual door hoistway plan'
      role='img'
      className='tech-svg'>
      ...
      <line
        ...
        strokeDasharray='5,3'
      />
      <text x='126' y='132' fontSize='13' fill='#01969C' fontWeight='700'>
        B
      </text>
      <rect
        x='20'
      ...
      <text
        ...
        fill='#8A9297'
        fontFamily='Inter,sans-serif'>
        C = Well Width · D = Well Depth · All dims mm
      </text>
    </svg>
  );
}
...
function AutoSVG() {
  return (
    <svg
      ...
      width='270'
      height='308'
      aria-label='Auto door hoistway plan'
      role='img'
      className='tech-svg'>
